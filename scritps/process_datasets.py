...
def compute_target(qa_data, id_questions, ans2label,
                   dataset='vqa2', split='val2014'):
    with open(f'data/cache/{dataset}-{split}.jsonl', 'w') as f:
...
def process_vqa2():
    ...
    train_id_questions = {i['question_id']: i['question']
    ...
    compute_target(train_answers, train_id_questions, trainval_ans2label,
                   dataset='vqa2', split='train2014')
    print('saved coco train2014')
    compute_target(val_answers, val_id_questions, trainval_ans2label,
                   dataset='vqa2', split='val2014')
    print('saved coco val2014')
    test_id_questions = {i['question_id']: i['question'] for i in test_questions}
    compute_target(test_questions, test_id_questions, {},
                   dataset='vqa2', split='test2015')
